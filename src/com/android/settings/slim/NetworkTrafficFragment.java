...
public class NetworkTrafficFragment extends SettingsPreferenceFragment implements OnPreferenceChangeListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        addPreferencesFromResource(R.xml.yoshi_network_traffic_settings);

        loadResources();

        // Compute default state (off, both incoming and outgoing traffic, 2s refresh period)
        int defaultState = 0;
        defaultState = setBit(defaultState, MASK_UP, true);
